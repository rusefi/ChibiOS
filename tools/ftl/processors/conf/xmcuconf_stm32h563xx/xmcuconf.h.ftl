...
#define STM32_IRQ_RTC_GLOBAL_PRIORITY       ${doc.STM32_IRQ_RTC_GLOBAL_PRIORITY!"6"}
#define STM32_IRQ_RTC_TAMP_PRIORITY         ${doc.STM32_IRQ_RTC_TAMP_PRIORITY!"6"}
...
#define STM32_ADC_ADC1_DMA3_CHANNEL         ${doc.STM32_ADC_ADC1_DMA3_CHANNEL!"STM32_DMA3_CHANNEL_ID_ANY"}
#define STM32_ADC_ADC2_DMA3_CHANNEL         ${doc.STM32_ADC_ADC2_DMA3_CHANNEL!"STM32_DMA3_CHANNEL_ID_ANY"}
...
#define STM32_WSPI_OCTOSPI1_DMA3_CHANNEL    ${doc.STM32_WSPI_OCTOSPI1_DMA3_CHANNEL!"STM32_DMA3_MASK_ANY"}
